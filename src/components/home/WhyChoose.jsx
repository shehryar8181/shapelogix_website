...
export default function WhyChoose() {
    return (
        <section className="why-choose wrapper relative pt-20! md:pt-30! lg:pt-[10vw]! bg-background">
            ...
            <div className="grid grid-cols-2 gap-4 px-2 mt-6 lg:mt-[3vw]">
                <div className="flex flex-col justify-between gap-2 relative z-11 bg-black py-5 px-4 rounded-lg lg:rounded-[1vw] lg:p-[2vw] min-h-[400px] lg:min-h-[44vw]">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col justify-between gap-2 relative z-11 overflow-hidden bg-[linear-gradient(180deg,#2C277F_0%,#4F46E5_100%)] py-5 px-4 rounded-lg lg:rounded-[1vw] lg:py-[2vw] lg:px-[1vw] h-[280px] lg:h-[28vw]">
                        <div>
                        ...
                        <div className="absolute left-0 bottom-1 mt-auto w-full text-center leading-none">
                            <h1 className=" text-black relative z-10 leading-none! font-black!">
                                FOCUS
                            </h1>
                            <h1 className=" text-white  lg:mt-[-3.4vw] translate-y-[28%] leading-none! font-black!">
                                MEANING
                            </h1>
                        </div>
                    </div>
                    ...
                    <div
                        className="flex flex-col justify-center items-center text-center gap-2 relative z-11 overflow-hidden bg-white py-5 px-4 rounded-lg lg:rounded-[1vw] lg:py-[2vw] lg:px-[1vw] h-[280px] lg:h-[28vw]"
                        style={{
                    ...
                    <div
                        className="relative z-11 overflow-hidden bg-white py-5 px-4 rounded-lg lg:rounded-[1vw] lg:py-[2vw] lg:px-[1vw] h-[280px] lg:h-[15vw]"
                    >
